...
def main():
    ...
    print("2. Configure webhook no painel do Mercado Pago")
    print("3. Adicione o bot aos grupos de notificação")
    print("\n💡 Use /config no bot para configurações avançadas")
...
echo "🔄 Atualizando SSH Bot Premium..."
